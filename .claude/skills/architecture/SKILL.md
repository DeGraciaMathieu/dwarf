...
`Needs → Attrition → Morale → GoblinSpawn → Migrant → Steward → Arbiter → JobAssignment → Eating → Drink → Sleep → Flee → Fight → Tantrum → Dig → Chop → Haul → Grave → Equip → Build → Craft → Farm → Fish → Hostile → Combat → Movement`
