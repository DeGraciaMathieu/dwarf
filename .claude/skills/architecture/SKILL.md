...
`Season → Needs → Attrition → Morale → Intoxication → GoblinSpawn → Migrant → RandomEvent → Steward → Arbiter → JobAssignment → Eating → Drink → Sleep → Socialize → Rescue → Heal → Flee → Fight → Brawl → Tantrum → Dig → Chop → Haul → Perish → Grave → Equip → Build → Craft → Demolish → Farm → Fish → Hostile → Combat → Injury → Movement → JobAlert → Chronicle`
