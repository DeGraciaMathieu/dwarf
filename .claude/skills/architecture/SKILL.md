...
`Needs → Attrition → Morale → Intoxication → GoblinSpawn → Migrant → Steward → Arbiter → JobAssignment → Eating → Drink → Sleep → Flee → Fight → Brawl → Tantrum → Dig → Chop → Haul → Grave → Equip → Build → Craft → Demolish → Farm → Fish → Hostile → Combat → Movement → JobAlert`
