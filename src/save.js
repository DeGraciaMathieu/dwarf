...
export function serializeGame({ world, terrain, jobBoard, stockpiles, farms, fishingSpots }) {
    const components = {};
...
export function restoreGame({ world, terrain, jobBoard, stockpiles, farms, fishingSpots }, snapshot) {
